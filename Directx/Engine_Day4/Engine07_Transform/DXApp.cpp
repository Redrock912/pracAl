...
bool DXApp::InitScene()
{
	...
	// 인덱스 버퍼 바인딩
	pDeviceContext->IASetIndexBuffer(indexBuffer,DXGI_FORMAT_R32_UINT,0); // 첫번째 좌표 만 쓰기 위해 r32만 사용
	...
	// World * View * Projection 공간 변형의 식
	// 월드 행렬
	world = XMMatrixIdentity();

	// 카메라 위치
	cameraPos = XMVectorSet(3.0f, 3.0f,-7.0f, 0.0f);
